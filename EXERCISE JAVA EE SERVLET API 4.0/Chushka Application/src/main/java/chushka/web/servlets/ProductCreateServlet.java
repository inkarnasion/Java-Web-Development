...
public class ProductCreateServlet extends HttpServlet {
    ...
    private final static String CREATE_PRODUCT_HTML_FILE_PATH = "/D:\\Java\\Java WEB 2019\\JAVA EE SERVLET API 4.0\\src\\main\\resources\\views\\create-product.html";
    ...
    private String formatTypeOptions(){
        ...
        Arrays.stream(Type.values()).forEach(type -> {
            options.append(String.format("<option value =\"%s\">%s</options>", type.name(), type.name())).append(System.lineSeparator());
        });
